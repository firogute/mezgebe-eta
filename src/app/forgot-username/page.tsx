...
export default async function ForgotUsernamePage({
  ...
  if (ticketNumber) {
    ...
    if (ticket?.reservation?.user) {
      ...
      foundPhone = ticket.reservation.user.phone;
    }
  }
    ...
    <div className="max-w-md mx-auto p-4 md:p-8">
      ...
      <div className="bg-card border border-border rounded-2xl p-6 shadow-sm">
        ...
        <p className="text-muted-foreground text-sm mb-6">
          Enter any ticket number from your purchase to retrieve your username.
        </p>
            ...
            {foundUsername ? (
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  Phone: {foundPhone || "Not available"}
                </p>
                <div className="mt-4">
                  <Link
                    href={`/receipt?username=${foundUsername}`}
              ...
              <p className="text-red-500 font-medium text-sm">
                No username found for this ticket number. Ensure it is correct
                and formatted like ETA-001-001.
              </p>
            )}
          </div>
        )}
